...
$root.SensorSchema = (function() {
     ...
     * @property {string|null} [unit] SensorSchema unit
     */
...
$root.ParameterValue = (function() {

    /**
     * Properties of a ParameterValue.
     * @exports IParameterValue
     * @interface IParameterValue
     * @property {string|null} [name] ParameterValue name
     * @property {string|null} [value] ParameterValue value
     */
     ...
     * @constructor
     * @param {IParameterValue=} [properties] Properties to set
     */
     ...
     * @static
     * @param {IParameterValue=} [properties] Properties to set
     * @returns {ParameterValue} ParameterValue instance
     */
     ...
     * @memberof ParameterValue
     * @static
     * @param {IParameterValue} message ParameterValue message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ParameterValue} ParameterValue
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ParameterValue.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ParameterValue();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ParameterValue.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.name != null && message.hasOwnProperty("name"))
            if (!$util.isString(message.name))
    ...
    ParameterValue.fromObject = function fromObject(object) {
        if (object instanceof $root.ParameterValue)
            return object;
        var message = new $root.ParameterValue();
        if (object.name != null)
            message.name = String(object.name);
        if (object.value != null)
            message.value = String(object.value);
     ...
     * @memberof ParameterValue
     * @static
     * @param {ParameterValue} message ParameterValue
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
...
$root.DeviceCommandRequest = (function() {

    /**
     * Properties of a DeviceCommandRequest.
     * @exports IDeviceCommandRequest
     * @interface IDeviceCommandRequest
     * @property {string|null} [method] DeviceCommandRequest method
     * @property {Array.<IParameterValue>|null} [parameters] DeviceCommandRequest parameters
     */

    /**
     * Constructs a new DeviceCommandRequest.
     * @exports DeviceCommandRequest
     * @classdesc Represents a DeviceCommandRequest.
     * @implements IDeviceCommandRequest
     * @constructor
     * @param {IDeviceCommandRequest=} [properties] Properties to set
     */
    function DeviceCommandRequest(properties) {
        this.parameters = [];
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
     ...
     * @memberof DeviceCommandRequest
     * @instance
     */
    DeviceCommandRequest.prototype.method = "";

    /**
     * DeviceCommandRequest parameters.
     * @member {Array.<IParameterValue>} parameters
     * @memberof DeviceCommandRequest
     * @instance
     */
    DeviceCommandRequest.prototype.parameters = $util.emptyArray;
     ...
     * @static
     * @param {IDeviceCommandRequest=} [properties] Properties to set
     * @returns {DeviceCommandRequest} DeviceCommandRequest instance
     */
    DeviceCommandRequest.create = function create(properties) {
        return new DeviceCommandRequest(properties);
    };
     ...
     * @memberof DeviceCommandRequest
     * @static
     * @param {IDeviceCommandRequest} message DeviceCommandRequest message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    DeviceCommandRequest.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        ...
        if (message.parameters != null && message.parameters.length)
            for (var i = 0; i < message.parameters.length; ++i)
                $root.ParameterValue.encode(message.parameters[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DeviceCommandRequest.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {DeviceCommandRequest} DeviceCommandRequest
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceCommandRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DeviceCommandRequest();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
            ...
            case 2:
                if (!(message.parameters && message.parameters.length))
                    message.parameters = [];
                message.parameters.push($root.ParameterValue.decode(reader, reader.uint32()));
                break;
            default:
                reader.skipType(tag & 7);
                break;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceCommandRequest.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    DeviceCommandRequest.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.method != null && message.hasOwnProperty("method"))
        ...
        if (message.parameters != null && message.hasOwnProperty("parameters")) {
            if (!Array.isArray(message.parameters))
                return "parameters: array expected";
            for (var i = 0; i < message.parameters.length; ++i) {
                var error = $root.ParameterValue.verify(message.parameters[i]);
                if (error)
                    return "parameters." + error;
            }
        }
     ...
     * @returns {DeviceCommandRequest} DeviceCommandRequest
     */
    DeviceCommandRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.DeviceCommandRequest)
            return object;
        var message = new $root.DeviceCommandRequest();
        if (object.method != null)
            message.method = String(object.method);
        if (object.parameters) {
            if (!Array.isArray(object.parameters))
                throw TypeError(".DeviceCommandRequest.parameters: array expected");
            message.parameters = [];
            for (var i = 0; i < object.parameters.length; ++i) {
                if (typeof object.parameters[i] !== "object")
                    throw TypeError(".DeviceCommandRequest.parameters: object expected");
                message.parameters[i] = $root.ParameterValue.fromObject(object.parameters[i]);
            }
        }
        return message;
    };
     ...
     * @memberof DeviceCommandRequest
     * @static
     * @param {DeviceCommandRequest} message DeviceCommandRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    DeviceCommandRequest.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.arrays || options.defaults)
        ...
        if (message.parameters && message.parameters.length) {
            object.parameters = [];
            for (var j = 0; j < message.parameters.length; ++j)
                object.parameters[j] = $root.ParameterValue.toObject(message.parameters[j], options);
        }
        return object;
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    DeviceCommandRequest.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
...
$root.DeviceCommandResponse = (function() {

    /**
     * Properties of a DeviceCommandResponse.
     * @exports IDeviceCommandResponse
     * @interface IDeviceCommandResponse
     * @property {string|null} [method] DeviceCommandResponse method
     * @property {string|null} [payload] DeviceCommandResponse payload
     */

    /**
     * Constructs a new DeviceCommandResponse.
     * @exports DeviceCommandResponse
     * @classdesc Represents a DeviceCommandResponse.
     * @implements IDeviceCommandResponse
     * @constructor
     * @param {IDeviceCommandResponse=} [properties] Properties to set
     */
    function DeviceCommandResponse(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @member {string} method
     * @memberof DeviceCommandResponse
     * @instance
     */
    DeviceCommandResponse.prototype.method = "";
     ...
     * @instance
     */
    DeviceCommandResponse.prototype.payload = "";
     ...
     * @static
     * @param {IDeviceCommandResponse=} [properties] Properties to set
     * @returns {DeviceCommandResponse} DeviceCommandResponse instance
     */
    DeviceCommandResponse.create = function create(properties) {
        return new DeviceCommandResponse(properties);
    };
     ...
     * @memberof DeviceCommandResponse
     * @static
     * @param {IDeviceCommandResponse} message DeviceCommandResponse message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    DeviceCommandResponse.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.method != null && message.hasOwnProperty("method"))
            writer.uint32(/* id 1, wireType 2 =*/10).string(message.method);
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DeviceCommandResponse.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {DeviceCommandResponse} DeviceCommandResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceCommandResponse.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DeviceCommandResponse();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceCommandResponse.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    DeviceCommandResponse.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.method != null && message.hasOwnProperty("method"))
            if (!$util.isString(message.method))
     ...
     * @returns {DeviceCommandResponse} DeviceCommandResponse
     */
    DeviceCommandResponse.fromObject = function fromObject(object) {
        if (object instanceof $root.DeviceCommandResponse)
            return object;
        var message = new $root.DeviceCommandResponse();
        if (object.method != null)
            message.method = String(object.method);
     ...
     * @memberof DeviceCommandResponse
     * @static
     * @param {DeviceCommandResponse} message DeviceCommandResponse
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    DeviceCommandResponse.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
     ...
     * @returns {Object.<string,*>} JSON object
     */
    DeviceCommandResponse.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
...
$root.DeviceService = (function() {

    /**
     * Constructs a new DeviceService service.
     * @exports DeviceService
     * @classdesc Represents a DeviceService
     ...
     */
    function DeviceService(rpcImpl, requestDelimited, responseDelimited) {
        $protobuf.rpc.Service.call(this, rpcImpl, requestDelimited, responseDelimited);
    }

    (DeviceService.prototype = Object.create($protobuf.rpc.Service.prototype)).constructor = DeviceService;
     ...
     * @param {boolean} [requestDelimited=false] Whether requests are length-delimited
     * @param {boolean} [responseDelimited=false] Whether responses are length-delimited
     * @returns {DeviceService} RPC service. Useful where requests and/or responses are streamed.
     */
    DeviceService.create = function create(rpcImpl, requestDelimited, responseDelimited) {
     ...
     * @memberof DeviceService
     * @typedef ExecuteCommandCallback
     * @type {function}
     * @param {Error|null} error Error, if any
     * @param {DeviceCommandResponse} [response] DeviceCommandResponse
     */
     ...
     * @memberof DeviceService
     * @instance
     * @param {IDeviceCommandRequest} request DeviceCommandRequest message or plain object
     * @param {DeviceService.ExecuteCommandCallback} callback Node-style callback called with the error, if any, and DeviceCommandResponse
     * @returns {undefined}
     * @variation 1
     */
    DeviceService.prototype.executeCommand = function executeCommand(request, callback) {
        return this.rpcCall(executeCommand, $root.DeviceCommandRequest, $root.DeviceCommandResponse, request, callback);
    };
     ...
     * @instance
     * @param {IDeviceCommandRequest} request DeviceCommandRequest message or plain object
     * @returns {Promise<DeviceCommandResponse>} Promise
     * @variation 2
     */
...
$root.ProcedureCallRequest = (function() {

    /**
     * Properties of a ProcedureCallRequest.
     * @exports IProcedureCallRequest
     * @interface IProcedureCallRequest
     * @property {string|null} [clientId] ProcedureCallRequest clientId
     * @property {string|null} [requestId] ProcedureCallRequest requestId
     * @property {string|null} [method] ProcedureCallRequest method
     * @property {Object.<string,string>|null} [headers] ProcedureCallRequest headers
     * @property {google.protobuf.IAny|null} [payload] ProcedureCallRequest payload
     */

    /**
     * Constructs a new ProcedureCallRequest.
     * @exports ProcedureCallRequest
     * @classdesc Represents a ProcedureCallRequest.
     * @implements IProcedureCallRequest
     * @constructor
     * @param {IProcedureCallRequest=} [properties] Properties to set
     */
    function ProcedureCallRequest(properties) {
        this.headers = {};
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
    ...
    /**
     * ProcedureCallRequest clientId.
     * @member {string} clientId
     * @memberof ProcedureCallRequest
     * @instance
     */
    ProcedureCallRequest.prototype.clientId = "";

    /**
     * ProcedureCallRequest requestId.
     * @member {string} requestId
     * @memberof ProcedureCallRequest
     * @instance
     */
    ProcedureCallRequest.prototype.requestId = "";

    /**
     * ProcedureCallRequest method.
     * @member {string} method
     * @memberof ProcedureCallRequest
     * @instance
     */
    ProcedureCallRequest.prototype.method = "";

    /**
     * ProcedureCallRequest headers.
     * @member {Object.<string,string>} headers
     * @memberof ProcedureCallRequest
     * @instance
     */
    ProcedureCallRequest.prototype.headers = $util.emptyObject;

    /**
     * ProcedureCallRequest payload.
     * @member {google.protobuf.IAny|null|undefined} payload
     * @memberof ProcedureCallRequest
     * @instance
     */
    ProcedureCallRequest.prototype.payload = null;

    /**
     * Creates a new ProcedureCallRequest instance using the specified properties.
     * @function create
     * @memberof ProcedureCallRequest
     * @static
     * @param {IProcedureCallRequest=} [properties] Properties to set
     * @returns {ProcedureCallRequest} ProcedureCallRequest instance
     */
    ProcedureCallRequest.create = function create(properties) {
        return new ProcedureCallRequest(properties);
    };

    /**
     * Encodes the specified ProcedureCallRequest message. Does not implicitly {@link ProcedureCallRequest.verify|verify} messages.
     * @function encode
     * @memberof ProcedureCallRequest
     * @static
     * @param {IProcedureCallRequest} message ProcedureCallRequest message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ProcedureCallRequest.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
    ...
    /**
     * Encodes the specified ProcedureCallRequest message, length delimited. Does not implicitly {@link ProcedureCallRequest.verify|verify} messages.
     * @function encodeDelimited
     * @memberof ProcedureCallRequest
     * @static
     * @param {IProcedureCallRequest} message ProcedureCallRequest message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ProcedureCallRequest.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a ProcedureCallRequest message from the specified reader or buffer.
     * @function decode
     * @memberof ProcedureCallRequest
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ProcedureCallRequest} ProcedureCallRequest
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ProcedureCallRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ProcedureCallRequest(), key;
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    /**
     * Decodes a ProcedureCallRequest message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof ProcedureCallRequest
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ProcedureCallRequest.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a ProcedureCallRequest message.
     * @function verify
     * @memberof ProcedureCallRequest
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ProcedureCallRequest.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.clientId != null && message.hasOwnProperty("clientId"))
    ...
    /**
     * Creates a ProcedureCallRequest message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof ProcedureCallRequest
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {ProcedureCallRequest} ProcedureCallRequest
     */
    ProcedureCallRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.ProcedureCallRequest)
            return object;
        var message = new $root.ProcedureCallRequest();
        ...
        if (object.headers) {
            if (typeof object.headers !== "object")
                throw TypeError(".ProcedureCallRequest.headers: object expected");
            message.headers = {};
        ...
        if (object.payload != null) {
            if (typeof object.payload !== "object")
                throw TypeError(".ProcedureCallRequest.payload: object expected");
    ...
    /**
     * Creates a plain object from a ProcedureCallRequest message. Also converts values to other types if specified.
     * @function toObject
     * @memberof ProcedureCallRequest
     * @static
     * @param {ProcedureCallRequest} message ProcedureCallRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ProcedureCallRequest.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
    ...
    /**
     * Converts this ProcedureCallRequest to JSON.
     * @function toJSON
     * @memberof ProcedureCallRequest
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    ProcedureCallRequest.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
...
$root.ProcedureCallResponse = (function() {

    /**
     * Properties of a ProcedureCallResponse.
     * @exports IProcedureCallResponse
     * @interface IProcedureCallResponse
     * @property {string|null} [clientId] ProcedureCallResponse clientId
    ...
    /**
     * Constructs a new ProcedureCallResponse.
     * @exports ProcedureCallResponse
     * @classdesc Represents a ProcedureCallResponse.
     * @implements IProcedureCallResponse
     * @constructor
     * @param {IProcedureCallResponse=} [properties] Properties to set
     */
    function ProcedureCallResponse(properties) {
        this.headers = {};
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
    ...
    /**
     * ProcedureCallResponse clientId.
     * @member {string} clientId
     * @memberof ProcedureCallResponse
     * @instance
     */
    ProcedureCallResponse.prototype.clientId = "";

    /**
     * ProcedureCallResponse requestId.
     * @member {string} requestId
     * @memberof ProcedureCallResponse
     * @instance
     */
    ProcedureCallResponse.prototype.requestId = "";

    /**
     * ProcedureCallResponse headers.
     * @member {Object.<string,string>} headers
     * @memberof ProcedureCallResponse
     * @instance
     */
    ProcedureCallResponse.prototype.headers = $util.emptyObject;

    /**
     * ProcedureCallResponse payload.
     * @member {google.protobuf.IAny|null|undefined} payload
     * @memberof ProcedureCallResponse
     * @instance
     */
     ...
     * @static
     * @param {IProcedureCallResponse=} [properties] Properties to set
     * @returns {ProcedureCallResponse} ProcedureCallResponse instance
     */
    ProcedureCallResponse.create = function create(properties) {
        return new ProcedureCallResponse(properties);
    };

    /**
     * Encodes the specified ProcedureCallResponse message. Does not implicitly {@link ProcedureCallResponse.verify|verify} messages.
     * @function encode
     * @memberof ProcedureCallResponse
     * @static
     * @param {IProcedureCallResponse} message ProcedureCallResponse message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ProcedureCallResponse.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.clientId != null && message.hasOwnProperty("clientId"))
            writer.uint32(/* id 1, wireType 2 =*/10).string(message.clientId);
    ...
    /**
     * Encodes the specified ProcedureCallResponse message, length delimited. Does not implicitly {@link ProcedureCallResponse.verify|verify} messages.
     * @function encodeDelimited
     * @memberof ProcedureCallResponse
     * @static
     * @param {IProcedureCallResponse} message ProcedureCallResponse message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ProcedureCallResponse.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a ProcedureCallResponse message from the specified reader or buffer.
     * @function decode
     * @memberof ProcedureCallResponse
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ProcedureCallResponse} ProcedureCallResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ProcedureCallResponse.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ProcedureCallResponse(), key;
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    /**
     * Decodes a ProcedureCallResponse message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof ProcedureCallResponse
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ProcedureCallResponse.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a ProcedureCallResponse message.
     * @function verify
     * @memberof ProcedureCallResponse
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ProcedureCallResponse.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.clientId != null && message.hasOwnProperty("clientId"))
            if (!$util.isString(message.clientId))
    ...
    /**
     * Creates a ProcedureCallResponse message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof ProcedureCallResponse
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {ProcedureCallResponse} ProcedureCallResponse
     */
    ProcedureCallResponse.fromObject = function fromObject(object) {
        if (object instanceof $root.ProcedureCallResponse)
            return object;
        var message = new $root.ProcedureCallResponse();
        if (object.clientId != null)
            message.clientId = String(object.clientId);
        if (object.requestId != null)
            message.requestId = String(object.requestId);
        if (object.headers) {
            if (typeof object.headers !== "object")
                throw TypeError(".ProcedureCallResponse.headers: object expected");
            message.headers = {};
            for (var keys = Object.keys(object.headers), i = 0; i < keys.length; ++i)
                message.headers[keys[i]] = String(object.headers[keys[i]]);
        }
    ...
    /**
     * Creates a plain object from a ProcedureCallResponse message. Also converts values to other types if specified.
     * @function toObject
     * @memberof ProcedureCallResponse
     * @static
     * @param {ProcedureCallResponse} message ProcedureCallResponse
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ProcedureCallResponse.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.objects || options.defaults)
    ...
    /**
     * Converts this ProcedureCallResponse to JSON.
     * @function toJSON
     * @memberof ProcedureCallResponse
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    ProcedureCallResponse.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
